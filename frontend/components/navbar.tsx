...
import { Bell, Search, VenetianMask } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/90">
      <div className="mx-auto flex h-16 max-w-[1600px] items-center gap-4 px-4">
        ...
        <div className="ml-auto flex items-center gap-1.5 md:ml-0">
          ...
          <ThemeToggle />
          <span className="ml-1 hidden items-center gap-2 rounded-full border border-slate-200 bg-slate-100 py-1.5 pl-2.5 pr-3 text-sm font-medium text-slate-700 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 sm:flex">
